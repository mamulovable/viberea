 ...
 * Every request to /api/* must include a valid Authorization: Bearer <token>
 * header. The middleware verifies the JWT and sets c.var.userId.
 */
 ...
 * Hono's app object satisfies this interface automatically.
 */
export default app;
